...
public class RubrosFragment extends Fragment {
    private final String TAG = RubrosFragment.class.getSimpleName();

    private RecyclerView reciclador;
    private ArrayList<Rubro> items = new ArrayList<>();
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        View v = inflater.inflate(R.layout.rubros_fragment, container, false);
    ...
    private void inicializarComponentes(View v) {
        ...
        if (!Almacen.getInstancia().getRubros().isEmpty()){
            mostrarRubros();
        } else {
            cargarRubros();
        }
    ...
    private void mostrarRubros() {
        if (!Almacen.getInstancia().getRubros().isEmpty()){
            items.clear();
            for (Rubro rubro : Almacen.getInstancia().getRubros()){
                Busqueda busqueda = new Busqueda();
                if (!busqueda.getComerciosPorRubro(rubro.getId()).isEmpty()){
                    items.add(rubro);
                }
            }
            ocultarMensaje();
        ...
        itemAdapter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Rubro rubro = items.get(reciclador.getChildPosition(v));
                mostrarSubrubros(rubro.getId());
            }
        });
    ...
    private void mostrarSubrubros(int idRubro) {
