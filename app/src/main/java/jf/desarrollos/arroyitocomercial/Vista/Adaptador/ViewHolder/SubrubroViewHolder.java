...
public class SubrubroViewHolder extends RecyclerView.ViewHolder {

    private TextView mFileNameTextView;
    public RoundedLetterView mRoundedLetterView;

    public SubrubroViewHolder(final View itemView) {
        super(itemView);
    ...
    public void bind(Context contexto, Subrubro model, int position) {
