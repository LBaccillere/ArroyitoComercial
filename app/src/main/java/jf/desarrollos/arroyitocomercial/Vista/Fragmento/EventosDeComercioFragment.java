...
public class EventosDeComercioFragment extends Fragment {
    private final String TAG = EventosDeComercioFragment.class.getSimpleName();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.eventos_de_comercio_fragment, container, false);
    ...
    public void cargarEventos(int idComercio) {

        JsonArrayRequest req = new JsonArrayRequest(Constantes.GET_EVENTOS_POR_COMERCIO + idComercio, new Response.Listener<JSONArray>() {
            @Override
